...
class WorkoutListAdapter extends ArraySwipeAdapter<Workout> {
	...
	private SwipeLayout.SwipeListener onSwipe(final SwipeLayout list, final RelativeLayout main,
			final LinearLayout delete, final Workout workout, final int position) {
